...
class TeamsTableSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        Team::create(array('name' => 'Stjørna', 'group_code' => 'B'));
        Team::create(array('name' => 'Fosen 2', 'group_code' => 'B'));
        Team::create(array('name' => 'Klæbu IL 1', 'group_code' => 'B'));
        ...
        Team::create(array('name' => 'Trygg/Lade 1', 'group_code' => 'C'));

        Team::create(array('name' => 'Leksvik', 'group_code' => 'D'));
        Team::create(array('name' => 'Skaun BK 1', 'group_code' => 'D'));
        Team::create(array('name' => 'Nardo FK 2', 'group_code' => 'D'));
        Team::create(array('name' => 'Klæbu IL 2', 'group_code' => 'D'));
        ...
        Team::create(array('name' => 'Buvik IL 3', 'group_code' => 'A'));

        Team::create(array('name' => 'Åfjord 1', 'group_code' => 'B'));
        Team::create(array('name' => 'Stjørna', 'group_code' => 'B'));
        Team::create(array('name' => 'Freidig 1', 'group_code' => 'B'));
        Team::create(array('name' => 'Klæbu IL 1', 'group_code' => 'B'));

        Team::create(array('name' => 'Vanvik/Stadsbygd 2', 'group_code' => 'C'));
        Team::create(array('name' => 'FK Fosen', 'group_code' => 'C'));
        Team::create(array('name' => 'Melhus 1', 'group_code' => 'C'));
        Team::create(array('name' => 'Buvik IL 2', 'group_code' => 'C'));

        Team::create(array('name' => 'Leksvik G15', 'group_code' => 'D'));
        Team::create(array('name' => 'Melhus 2', 'group_code' => 'D'));
        Team::create(array('name' => 'Buvik IL 1', 'group_code' => 'D'));
        Team::create(array('name' => 'Klæbu IL 2', 'group_code' => 'D'));



        Team::create(array('name' => 'Stadsbygd 1', 'group_code' => 'A'));
        Team::create(array('name' => 'Melhus 2', 'group_code' => 'A'));
        Team::create(array('name' => 'Stadsbygd 3', 'group_code' => 'A'));
        Team::create(array('name' => 'Skaun BK 1', 'group_code' => 'A'));
        ...
        Team::create(array('name' => 'Klæbu IL 1', 'group_code' => 'A'));
        Team::create(array('name' => 'Klæbu IL 2', 'group_code' => 'A'));
        Team::create(array('name' => 'Rissa IL', 'group_code' => 'A'));
        Team::create(array('name' => 'Tiller IL', 'group_code' => 'A'));
        Team::create(array('name' => 'Malvik IL', 'group_code' => 'A'));
        Team::create(array('name' => 'Utleira IL', 'group_code' => 'A'));

        Team::create(array('name' => 'Åfjord 1', 'group_code' => 'B'));
        Team::create(array('name' => 'Åfjord 2', 'group_code' => 'B'));
        Team::create(array('name' => 'Klæbu IL', 'group_code' => 'B'));
        Team::create(array('name' => 'FK Fosen', 'group_code' => 'B'));
        Team::create(array('name' => 'FK Fosen J13', 'group_code' => 'B'));
    }
}
...
class MatchesTableSeeder extends Seeder {
    ...
    public function run() {
        ...
        $this->generateTournamentCustomJ15(3, 21 + 16 + 16);
        $this->generateTournamentCustomJ14AndJ17(4, 21 + 16 + 16 + 7);
    ...
    private function generateTournamentCustomJ15($tournament_id, $team_id) {
        $this->generateMatch($tournament_id, '09:00', 1, 'A', $team_id, $team_id + 1);
        ...
        $this->generateMatch($tournament_id, '09:40', 1, 'A', $team_id + 1, $team_id + 2);
        $this->generateMatch($tournament_id, '09:40', 2, 'A', $team_id + 3, $team_id);

        $this->generateMatch($tournament_id, '10:00', 1, 'B', $team_id + 1 + 4, $team_id + 2 + 4);
        $this->generateMatch($tournament_id, '10:00', 2, 'B', $team_id + 3 + 4, $team_id + 4);

        $this->generateMatch($tournament_id, '10:20', 1, 'A', $team_id, $team_id + 2);
        $this->generateMatch($tournament_id, '10:20', 2, 'A', $team_id + 3, $team_id + 1);

        $this->generateMatch($tournament_id, '10:40', 1, 'B', $team_id + 4, $team_id + 2 + 4);
        $this->generateMatch($tournament_id, '10:40', 2, 'B', $team_id + 3 + 4, $team_id + 1 + 4);

        $this->generateMatch($tournament_id, '11:10', 1, 'S1', 1, 4);
        $this->generateMatch($tournament_id, '11:10', 2, 'S2', 3, 2);

        $this->generateMatch($tournament_id, '11:40', 1, 'F', 13, 14);
        $this->generateMatch($tournament_id, '11:40', 2, 'BF', 15, 16);
    }
    ...
    private function generateTournamentCustomJ14AndJ17($tournament_id, $team_id) {
        $this->generateMatch($tournament_id, '12:00', 1, 'B', $team_id + 9, $team_id + 11);
        $this->generateMatch($tournament_id, '12:00', 2, 'B', $team_id + 7, $team_id + 8);

        $this->generateMatch($tournament_id, '12:20', 1, 'A', $team_id + 2, $team_id + 4);
        $this->generateMatch($tournament_id, '12:20', 2, 'A', $team_id + 3, $team_id + 6);
        $this->generateMatch($tournament_id, '12:40', 1, 'A', $team_id + 1, $team_id + 5);

        $this->generateMatch($tournament_id, '12:40', 2, 'B', $team_id + 7, $team_id + 9);
        $this->generateMatch($tournament_id, '13:00', 1, 'B', $team_id + 11, $team_id + 10);

        $this->generateMatch($tournament_id, '13:00', 2, 'A', $team_id + 4, $team_id + 3);
        $this->generateMatch($tournament_id, '13:20', 1, 'A', $team_id + 6, $team_id + 1);
        $this->generateMatch($tournament_id, '13:20', 2, 'A', $team_id + 5, $team_id + 2);

        $this->generateMatch($tournament_id, '13:40', 1, 'B', $team_id + 10, $team_id + 7);
        $this->generateMatch($tournament_id, '13:40', 2, 'B', $team_id + 9, $team_id + 8);

        $this->generateMatch($tournament_id, '14:10', 1, 'A', $team_id + 3, $team_id + 5);
        $this->generateMatch($tournament_id, '14:10', 2, 'A', $team_id + 1, $team_id + 2);
        $this->generateMatch($tournament_id, '14:40', 1, 'A', $team_id + 6, $team_id + 4);

        $this->generateMatch($tournament_id, '14:40', 2, 'B', $team_id + 10, $team_id + 9);
        $this->generateMatch($tournament_id, '15:00', 1, 'B', $team_id + 8, $team_id + 11);

        $this->generateMatch($tournament_id, '15:00', 2, 'A', $team_id + 3, $team_id + 1);
        $this->generateMatch($tournament_id, '15:20', 1, 'A', $team_id + 4, $team_id + 5);
        $this->generateMatch($tournament_id, '15:20', 2, 'A', $team_id + 2, $team_id + 6);

        $this->generateMatch($tournament_id, '15:40', 1, 'B', $team_id + 11, $team_id + 7);
        $this->generateMatch($tournament_id, '15:40', 2, 'B', $team_id + 10, $team_id + 8);

        $this->generateMatch($tournament_id, '16:00', 1, 'A', $team_id + 5, $team_id + 6);
        $this->generateMatch($tournament_id, '16:00', 2, 'A', $team_id + 2, $team_id + 3);
        $this->generateMatch($tournament_id, '16:20', 2, 'A', $team_id + 4, $team_id + 1);
    }
