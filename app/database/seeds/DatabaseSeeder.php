...
class TeamsTableSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        Team::create(array('name' => 'Kromrygga Pipstalka', 'group_code' => 'A'));
        Team::create(array('name' => 'Valgus', 'group_code' => 'A'));
        Team::create(array('name' => 'Skrtel’s', 'group_code' => 'A'));

        Team::create(array('name' => '50 shades of O’shea', 'group_code' => 'B'));
        Team::create(array('name' => 'Hil/Fevåg Oldboys', 'group_code' => 'B'));
        Team::create(array('name' => 'RFSU', 'group_code' => 'B'));
        Team::create(array('name' => 'Orkitj Fc', 'group_code' => 'B'));
        Team::create(array('name' => 'Jumboflyers', 'group_code' => 'B'));

        Team::create(array('name' => 'Kråkvåg IL', 'group_code' => 'C'));
        Team::create(array('name' => 'The Gunners', 'group_code' => 'C'));
        Team::create(array('name' => 'Likast Laget Fc', 'group_code' => 'C'));
        Team::create(array('name' => 'Ibrakadabra', 'group_code' => 'C'));
        Team::create(array('name' => 'SGG', 'group_code' => 'C'));

        Team::create(array('name' => 'Team Fjeldvær', 'group_code' => 'D'));
        Team::create(array('name' => 'Fjell-Liv', 'group_code' => 'D'));
        Team::create(array('name' => 'Blakken', 'group_code' => 'D'));
        Team::create(array('name' => 'Fc Innherredsodd', 'group_code' => 'D'));
        Team::create(array('name' => 'Ragazzi', 'group_code' => 'D'));

				Team::create(array('name' => 'Jentefotball er også fotball', 'group_code' => 'W'));
        Team::create(array('name' => 'Champiis', 'group_code' => 'W'));
        Team::create(array('name' => 'Nederlaget', 'group_code' => 'W'));
        Team::create(array('name' => 'Fosningan', 'group_code' => 'W'));
        Team::create(array('name' => 'De navnløse piker', 'group_code' => 'W'));
    }
}
...
class MatchesTableSeeder extends Seeder {
    ...
    public function run() {
        ...
        $this->generateMatch(1, '11:00', 2, 'W', 2+20, 5+20);
				...
				//
				$this->generateMatch(1, '11:45', 1, 'C', 1+10, 3+10);
				$this->generateMatch(1, '11:45', 2, 'C', 4+10, 5+10);
				//
				...
				//
				$this->generateMatch(1, '13:00', 1, 'C', 1+10, 2+10);
				$this->generateMatch(1, '13:00', 2, 'C', 3+10, 4+10);
				//
        ...
        $this->generateMatch(1, '14:45', 2, 'W', 2+20, 3+20);
				...
				$this->generateMatch(1, '16:15', 1, 'Q1', null, null);
        $this->generateMatch(1, '16:15', 2, 'Q2', null, null);

        $this->generateMatch(1, '16:30', 1, 'Q3', null, null);
        $this->generateMatch(1, '16:30', 2, 'Q4', null, null);

				$this->generateMatch(1, '16:45', 1, 'F', null, null);

        $this->generateMatch(1, '17:00', 1, 'S1', null, null);
        $this->generateMatch(1, '17:00', 2, 'S2', null, null);

        $this->generateMatch(1, '17:30', 1, 'F', null, null);
