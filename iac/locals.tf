locals {
  ...
  better_auth_email_sender_input = trimspace(coalesce(var.better_auth_email_sender, ""))
  ses_source_email_input         = trimspace(coalesce(var.ses_source_email, ""))
  ses_region_input               = trimspace(coalesce(var.ses_region, ""))
  ses_domain_input               = trimspace(coalesce(var.ses_domain, ""))
  ses_mail_from_input            = trimspace(coalesce(var.ses_mail_from_domain, ""))
